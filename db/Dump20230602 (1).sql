CREATE DATABASE  IF NOT EXISTS `bd_citas` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_citas`;
...
CREATE TABLE `ins_seg_fisio` (
  ...
  `evolucion` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `observacion` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `fecha_reg` date NOT NULL,
  `per_salud_id_reg` int NOT NULL,
  `f_reg` datetime NOT NULL,
  `per_salud_id_mod` int NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=787 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=188 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-02 16:42:28
