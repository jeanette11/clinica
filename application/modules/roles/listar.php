                      ...
                      <div class="margin">
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu" role="menu">
                                ...
                                <a class="dropdown-item" href="?/roles/crear">Crear rol</a>
                                <?php endif ?>  
                                <?php if ($permiso_imprimir) : ?> 
                                <a class="dropdown-item" href="?/roles/imprimir">Imprimir roles</a>
                                <?php endif ?>  
                              </div>
                            </div> 
                        </div>
              ...
              <?php if ($message = get_notification()) : ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($permiso_eliminar): ?>
                        <a href="?/roles/eliminar/<?= $rol['id_rol']; ?>" data-toggle="tooltip" data-title="Eliminar rol" data-eliminar="true" class="btn btn-danger btn-sm"><span class="icon-trash">Eliminar</span></a>
                        <!--button type="button" class="btn btn-danger btn-xs" href="?/roles/eliminar/<?= $rol['id_rol']; ?>" data-eliminar="true" >Eliminar</button-->
                      <?php endif ?>
                      <?php if($permiso_modificar): ?>
                        <a href="?/roles/modificar/<?= $rol['id_rol']; ?>" data-toggle="tooltip" data-target="Modifica rol"  data-title="Modificar rol" style="color:white" class="btn btn-warning btn-sm"><span class="icon-note">Modificar</span></a>
                        <!--button type="button" class="btn btn-warning btn-xs" href="?/roles/modificar/<?= $rol['id_rol']; ?>"  >Modificar</button-->
                      <?php endif ?>
                ...
                <div class="alert alert-info">
                  ...
                  <ul>
                    ...
                    <li>Para crear nuevos roles debe hacer clic en el botón <kbd>Nuevo</kbd>.</li>
                  </ul>
                </div>
                <?php endif ?>
