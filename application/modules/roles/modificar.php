...
// Obtiene el rol
$rol = $db->from('ins_roles')->where('id_rol', $id_rol)->fetch_first();
...
<!-- 	<div class="row">
	...
	<?php endif ?>
			...
			<form method="post" id="modrol" action="?/roles/guardar" autocomplete="off">
  ...
  $('#modrol').validate({
    ...
    messages: {
     rol: {
      ...
      descripcion: "Por favor, introduce una breve descripción del rol",
    },
    errorElement: 'span',
