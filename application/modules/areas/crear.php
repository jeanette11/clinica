            ...
            <div class="card-body">
                ...
                <div class="col-sm-2  col-md-2"></div>
                    <div class="col-sm-8  col-md-8">
                        <form method="post" action="?/areas/guardar" id="creararea" autocomplete="off" enctype="multipart/form-data">
                            <input type="hidden" name="<?= $csrf; ?>">
                            <div class="form-group">
                                <label for="rol" class="control-label">Área:</label>
                                <input type="text" value="" name="area" id="area" class="form-control" autofocus="autofocus" data-validation="required letternumber length" data-validation-allowing="-# " data-validation-length="max100">
                            </div>
                            <div class="form-group">
