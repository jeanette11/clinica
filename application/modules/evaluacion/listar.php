                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <input type="hidden" id="codigo">
                                    <!-- datos para la reserva de evaluacion -->
                                    <div class="row">
                                        ...
                                        <div class="card card-primary card-tabs">
                                          <div class="card-header p-0 pt-1">
                                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                              <li class="nav-item">
                                                <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Tutor</a>
                                              </li>
                                              <li class="nav-item">
                                                <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Paciente</a>
                                              </li>
                                              <li class="nav-item">
                                                <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill" href="#custom-tabs-one-messages" role="tab" aria-controls="custom-tabs-one-messages" aria-selected="false">Anamnesis</a>
                                              </li>
                                            </ul>
                                          </div>
                                          <div class="card-body">
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                              <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                ...
                                                <div class="row">
                                                  <div class="col-9">
                                                      <div class="form-group">
                                                          ...
                                                          <input type="text" class="form-control" id="nombret" name="nombret" placeholder="Nombre completo">
                                                      </div>
                                                  </div>
                                                  <div class="col-3">
                                                          <div class="form-group">
                                                              ...
                                                              <input class="form-check-input" type="radio" name="generot" value="F">
                                                              <label class="form-check-label">Femenino</label>
                                                              </div>
                                                              <div class="form-check">
                                                              <input class="form-check-input" type="radio" name="generot" value="M" checked>
                                                ...
                                                <div class="row">
                                                      <div class="col-6"><label>Ap. Paterno</label>
                                                          <input type="text" id="paternot" name="paternot" class="form-control" placeholder="Paterno">
                                                      </div>
                                                      <div class="col-6"><label>Ap. Materno</label>
                                                          <input type="text" id="maternot" name="maternot" class="form-control" placeholder="Materno">
                                                      </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                      <div class="col-4">
                                                          <div class="form-group">
                                                              ...
                                                              <input type="text" class="form-control" id="nrodocumentot" name="nrodocumentot" placeholder="Nro. de documento">
                                                          </div>
                                                      </div>
                                                      <div class="col-3">
                                                          <div class="form-group">
                                                              <label>Complemento</label>
                                                              <input type="text" class="form-control" id="complementot" name="complementot" placeholder="Complemento">
                                                          </div>
                                                      </div>
                                                      <div class="col-5">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="tipodoct" name="tipodoct" class="form-control">
                                                ...
                                                <div class="row">
                                                      <div class="col-6">
                                                          <div class="form-group">
                                                              <label>Celular</label>
                                                              <input type="text" class="form-control" id="celulart" name="celulart" placeholder="Nro. celular">
                                                          </div>
                                                      </div>
                                                      <div class="col-6">
                                                            <!-- select parentesco -->
                                              ...
                                              <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                                ...
                                                <div class="row">
                                                  <div class="col-9">
                                                      <div class="form-group">
                                                          ...
                                                          <input type="text" class="form-control" id="nombrep" name="nombrep" placeholder="Nombre completo" data-validation="required">
                                                      </div>
                                                  </div>
                                                  <div class="col-3">
                                                          <div class="form-group">
                                                              <label>Género</label>
                                                              <div class="form-check">
                                                              <input class="form-check-input" type="radio" name="generop" value="F">
                                                              <label class="form-check-label">Femenino</label>
                                                              </div>
                                                              <div class="form-check">
                                                              <input class="form-check-input" type="radio" name="generop" value="M" checked>
                                                              <label class="form-check-label">Masculino</label>
                                                              </div>
                                                          </div>
                                                  </div>
                                                ...
                                                <div class="row">
                                                      <div class="col-6"><label>Ap. Paterno</label>
                                                          <input type="text" id="paternop" name="paternop" class="form-control" placeholder="Paterno">
                                                      </div>
                                                      <div class="col-6"><label>Ap. Materno</label>
                                                          <input type="text" id="maternop" name="maternop" class="form-control" placeholder="Materno">
                                                      </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                      <div class="col-4">
                                                          <div class="form-group">
                                                              <label>Nro. Documento</label>
                                                              <input type="text" class="form-control" id="nrodocumentop" name="nrodocumentop" placeholder="Nro. de documento">
                                                          </div>
                                                      </div>
                                                      <div class="col-3">
                                                          <div class="form-group">
                                                              <label>Complemento</label>
                                                              <input type="text" class="form-control" id="complementop" name="complementop" placeholder="Complemento">
                                                          </div>
                                                      </div>
                                                      <div class="col-5">
                                                                <!-- select tipo de documento -->
                                                                <div class="form-group">
                                                                    <label>Tipo de documento</label>
                                                                    <select id="tipodocp" name="tipodocp" class="form-control">
                                                                    <option value="Carnet">Carnet</option>
                                                                    <option value="Pasaporte">Pasaporte</option>
                                                                    <option value="Licencia">Licencia</option>
                                                                    </select>
                                                ...
                                                <div class="row">
                                                      <div class="col-6">
                                                          <div class="form-group">
                                                              <label>Celular</label>
                                                              <input type="text" class="form-control" id="celularp" name="celularp" placeholder="Nro. celular">
                                                          </div>
                                                      </div>
                                                  ...
                                                  <div class="row">
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="diagnostico" class="form-control" name="diagnostico" rows="3"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                <label>Impedimento</label>                                                            
                                                                <textarea id="impedimento" class="form-control" name="impedimento" rows="3"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                          <div class="form-group">
                                                              <label>Observación</label>
                                                              <!--nput type="textarea" class="form-control" id="observacion" name="observacion" placeholder="Escriba si tiene alguna observacion"-->
                                                  ...
                                                  <div class="row">
                                                      <div class="col-4">
                                                        ...
                                                        <div class="col-4">
                                                            <!-- select tipo de documento -->
                                                            <div class="form-group">
                                                                  <label>Tarifa evaluación</label>
                                                                  <select id="tarifa" name="tarifa" class="form-control">
                                                                  <option value="1">Tarifa Evaluacion 1</option>
                                                                  <option value="2">Tarifa Evaluacion 2</option>
                                                                  <option value="3">Tarifa Evaluacion 3</option>
                                                                  </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            ...
                                                            <div class="form-group">
                                                                  <label>Campaña</label>
                                                                  <select id="campania" name="campania" class="form-control">
                                                                  <option value="1">Ninguna</option>
                                                                  <option value="2">Caderitas</option>
                                                 ...
                                                 <div class="row">
                                                      ...
                                                      <div class="col-6">
                                                        ...
                                                        <div class="input-group" data-autoclose="true">
                                                            <input type="hidden" id="dia">
                                                            <input type="date" id="FechaInicio" value="" class="form-control" />
                                                            <input type="hidden" id="FechaFin" value="" class="form-control" />
                                                        </div>
                                                      </div>
                                                 </div>                                              
                                                 <div class="row" id="horarios"></div>
                                                
                                                <div class="row">
                                                  <div class="col-6">
                                                      <div class="form-group">
                                                        <label>Hora de inicio: </label> 
                                                        <input type="text" id="HoraInicio" disabled value="" class="form-control" />
                                                      </div>
                                                  </div>
                                                  <div class="col-6">
                                                      <div class="form-group">
                                                        <label>Hora de fin: </label>
                                                        <input type="text" id="HoraFin" disabled value=""  class="form-control" />
                                                      </div>
                                                  </div>
                                                </div>
