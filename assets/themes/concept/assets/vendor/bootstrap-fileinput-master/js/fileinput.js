...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="fa fa-fw icon-trash"></i>',
                    removeClass: 'btn btn-xs btn-kv btn-default btn-outline-secondary',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="fa fa-fw icon-cloud-upload"></i>',
                    uploadClass: 'btn btn-xs btn-kv btn-default btn-outline-secondary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="fa fa-fw icon-cloud-download"></i>',
                    downloadClass: 'btn btn-xs btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fa fa-fw icon-size-fullscreen"></i>',
                    zoomClass: 'btn btn-xs btn-kv btn-default btn-outline-secondary',
    ...
    $.fn.fileinput.defaults = {
        language: 'en',
        showCaption: false, //oculta el input de examinar
        showBrowse: false, //oculta el boton examinar
        showPreview: true,
        showRemove: true,
        showUpload: false,
        ...
        uploadClass: 'btn btn-default btn-primary',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadParamNames: {
